...
<html>
  <head>
    <!-- Google Fonts -->
      <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-5S85L38R1M"></script>
  <script>
    ...
    */
      * {
      ...
      pre {
        border-left: 0.3rem solid #ca7b4d;
      }
      pre code {
        word-wrap: normal;
        color: black;
  ...
  <body>
    ...
    <div id="layout">
      ...
      <article id="main" class="content">
        <a href="https://github.com/Hude06?tab=repositories">github</a>
        <a href="https://judemakes.dev/projects">projects</a>
        <a href="https://judemakes.com">judemakes</a>
